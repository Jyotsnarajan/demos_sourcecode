...
int main(int argc, char **argv) {
    ...
    if (argc < 5) {
        printf("usage: img_diff_ipol image1 image2 add_noise sigma difference\n");
        return EXIT_FAILURE;
    }
    ...
    if (io_png_write_f32(argv[5], difference, (size_t) d_w, (size_t) d_h, (size_t) d_c) != 0) {
